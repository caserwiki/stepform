...
namespace Zx\Admin\FormStep;

use Closure;
use Zx\Admin\Form as ParentForm;
use Zx\Admin\Http\JsonResponse;
use Zx\Admin\FormStep\Form;
...
class Builder
{
    ...
    protected function makeDefaultCompletionPage()
    {
        $this->done(function () {
            ...
            return view('zhanxin.stepform::completion-page', $data);
        });
    }
    ...
    /**
     * @param string|\Zx\Admin\Form\Field $field
     *
     * @return void
     */
...
JS;
    ...
    /**
     * @param string|\Zx\Admin\Form\Field $column
     *
     * @return false|int
     */
    ...
    {
        $this->form->builder()->view('zhanxin.stepform::steps');
